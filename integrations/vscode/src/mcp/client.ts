...
export class MCPClient extends EventEmitter {
    ...
    async validateAction(actionType: string, description: string): Promise<ValidationResult> {
    ...
    async safeWrite(filePath: string, content: string): Promise<SecurityScanResult> {
    ...
    async proposeStrategy(goalDescription: string): Promise<StrategyRecommendation> {
        return this.callTool('propose_strategy', {
            goal_description: goalDescription,
        }) as Promise<StrategyRecommendation>;
    }

    async recordHandover(goalId: string, content: string, warnings: string[]): Promise<void> {
